...
const settingUpdaters: {
  ...
  cleanup_level: (value) => commands.changeCleanupLevelSetting(value as string),
  share_context_with_remote: (value) =>
    commands.changeShareContextWithRemoteSetting(value as boolean),
